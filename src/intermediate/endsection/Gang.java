...
public class Gang {
    ...
    Gang(){
        ...
        robItems[0] = new Item("Blunt Smiss knife", 10.0);
        robItems[1] = new Item("Haft rotten apple", 0.0);
        ...
        Criminal bobby = new Criminal("Bobby", "The mountain", 1976, "knocking out",bobbyItems);
        criminals[1] = bobby;
    }
    ...
    private boolean isSuccessfulRobby(){
    ...
    public void letsRob(Building[] buildings){
        ...
        if(isSuccessfulRobby()){
            ...
            System.out.println("The gang tried to rob the" + buildings[randomBuildingIndex].getName()+ " but the failed.");
        }
    }
}
