package advanced.collections.linklist;
...
//        morningRoutine.add("Taking the dog for walk");
//        morningRoutine.add("Doing 32 push-ups");

        morningRoutine.add("Brushing my teeth");
        morningRoutine.addFirst("Taking the dog for walk");
        ...
        System.out.println("I completed the first element on my list: " + morningRoutine.pollLast());
        System.out.println(morningRoutine);
    }
}
